...
Запуск программы осуществляется в файле `lake_inferface.py` &mdash; это интерфейс программы. После запуска появляется окно, где нужно ввести стоимостный коэффициент и название csv файла. Файл должен быть в одном папке с файлами программы.
...
Если хотите создать новый путь, то стоит закрыть программу и открыть её снова.
...
Разделителем в этом csv файле является символ ;

...
Файл `res.data` содержит координаты с озером для матрицы 800х800. Программа обрабатывает этот файл очень долго из-за большого кол-во данных. Программа записывает в csv файл примерно по 5-6 гб в час.
